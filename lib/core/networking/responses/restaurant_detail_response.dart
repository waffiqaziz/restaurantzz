...
RestaurantDetailResponse detailRestaurantFromJson(String str) => RestaurantDetailResponse.fromJson(json.decode(str));

String detailRestaurantToJson(RestaurantDetailResponse data) => json.encode(data.toJson());
