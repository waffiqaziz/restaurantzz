...
class RestaurantDetailResponse {
  ...
  RestaurantDetailResponse({required this.error, required this.message, required this.restaurant});
...
class RestaurantDetailItem {
  ...
  factory RestaurantDetailItem.fromJson(Map<String, dynamic> json) => RestaurantDetailItem(
    ...
    categories:
        (json["categories"] as List<dynamic>?)?.map((x) => Category.fromJson(x)).toList() ?? [],
...
class Category {
  ...
  factory Category.fromJson(Map<String, dynamic> json) => Category(name: json["name"]);
...
class CustomerReview {
  ...
  factory CustomerReview.fromJson(Map<String, dynamic> json) =>
      CustomerReview(name: json["name"], review: json["review"], date: json["date"]);
