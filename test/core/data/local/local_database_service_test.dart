...
void main() {
  ...
  group('LocalDatabaseService', () {
    ...
    // TODO: databaseFactory use databaseFactoryFfiWeb not yet tested for web platform.
    // test('uses databaseFactoryFfiWeb on web platform', () async {
    //   final service = LocalDatabaseService();

    //   await service.database;

    //   // Verify that the correct database factory was set
    //   expect(databaseFactory, databaseFactoryFfiWeb);
    // });
