  ...
  group('FavoriteIconWidget', () {
    ...
    Widget createWidgetUnderTest() {
      return MultiProvider(
        ...
        child: MaterialApp(
          home: Scaffold(
            body: FavoriteIconWidget(restaurant: testRestaurant),
          ),
        ),
      );
    }

    testWidgets('initialState_showsFavoriteOutlineRoundedIcon',
    ...
    testWidgets('tappingIcon_ShouldUpdatesTheIconFavorite',
        (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      expect(find.byIcon(Icons.favorite_outline_rounded), findsOneWidget);
