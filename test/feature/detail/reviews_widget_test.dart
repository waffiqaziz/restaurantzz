...
void main() {
  group('ReviewsWidget', () {
    ...
    Widget createWidgetUnderTest() {
      return MaterialApp(
        home: Scaffold(body: ReviewsWidget(customerReviews: sampleReviews)),
      );
    }

    testWidgets('renderReviewsWidget_showsReviewSection', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());

      expect(find.text('Reviews'), findsOneWidget);
    });

    testWidgets('tapSeeReviews_expandsAndDisplaysCustomerReviews', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
    ...
    testWidgets('renderCustomerReview_showsNameDateAndReview', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
    ...
    testWidgets('tapReadMore_expandsTextAndDisplaysFullReview', (WidgetTester tester) async {
      ...
      expect(find.textContaining('Lorem Ipsum is simply dummy text'), findsOneWidget);
    });

    testWidgets('tapShowLess_collapsesTextToOriginalState', (WidgetTester tester) async {
